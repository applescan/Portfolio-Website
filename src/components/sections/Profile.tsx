    ...
    <section id="home" className="wrapper">
          ...
          <div className="padding-top-10">
            <div className="responsive-button wide">
              <a href="https://www.institutedata.com/blog/unlocking-potential-felicias-journey-from-design-to-software-engineering/" target="_blank" rel="noopener noreferrer">
                <Button title="My Software Dev Journey: An Interview with Institute of Data" border={true} />
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="right-side">
        <div className="image-wrapper">
          <img className="radius8" height={500} width={500} src={'/img/felicia-profile-2.png'} alt="profile-image" style={{ zIndex: 9 }} />
